...
class ModifyFile:
    ...
    def open_file(self, file_name):
        """ method of opening indicated file_name """
        if os.path.isfile(file_name):
            ...
            if ext == ".csv":
                ...
                raise OpenErrorExtentionException('Error: File open problem!')
            return True, print(f'SRC-FILE: "{file_name}"\nData loaded correctly.')
        else:
            raise NoFileException()

    def save_file(self, file_name):
        """ method of saving data to indicated file_name """
        ext = os.path.splitext(file_name)[1]
        if ext == ".csv":
            ...
            raise SaveErrorExtentionException('Error: File write problem!')
    ...
    def save_jsonfile(self, file_name):
        ...
        with open(file_name, "a") as file:
            file.write(json.dumps(self.jiff_list, indent=4))
        return True
    ...
    def change_csvdata(self, change_data):
        """ method of changing data in file_name """
    ...
    def print_data(self):
        """ method of printing data from file_name """
        for line in self.jiff_list:
