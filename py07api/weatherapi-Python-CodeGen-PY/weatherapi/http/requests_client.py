...
from weatherapi.http.http_client import HttpClient
from weatherapi.http.http_method_enum import HttpMethodEnum
from weatherapi.http.http_response import HttpResponse
